"""Shared LRSG bases with support-conditioned scalar and rank residuals."""
import math
...
class TaskConditionedTransport(LowRankTransport):
    ...
    def condition(self, task_embedding):
        if self.gate_net is None:
            return None
        residuals = self.gate_net(task_embedding.detach())
